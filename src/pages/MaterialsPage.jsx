    ...
    <div className="space-y-8">
      ...
      >
        <div>
          ...
          <a
            href="https://drive.google.com/drive/folders/1zkP7dNqiFDPDQ8nvc4376Vc0b-PJpaO7"
            target="_blank"
          ...
          <DialogContent className="sm:max-w-[480px] bg-background/90 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 py-2">
              ...
              <div>
                ...
                <Input id="author" name="author" value={newMaterial.author} onChange={handleInputChange} placeholder="Contoh: Nama Anda" className="mt-1" />
              </div>
              <div>
              ...
              <DialogFooter>
                ...
                <Button type="submit">{currentMaterial ? 'Simpan Perubahan' : 'Tambahkan Materi'}</Button>
              </DialogFooter>
            </form>
          </DialogContent>
        </Dialog>
